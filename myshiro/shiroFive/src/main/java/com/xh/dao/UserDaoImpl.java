...
import com.xh.JdbcTemplateUtils;
...
public class UserDaoImpl implements UserDao {
    ...
    public void updateUser(User user) {
        String sql="update sys_users set username=?,password=?,locked=? where id=?";
        jdbcTemplate.update(sql,user.getUsername(),user.getPassword(),user.getLocked(),user.getId());
    }
    ...
    public void correlationRoles(Long userId, Long... roleIds) {
        ...
        for(Long roleId : roleIds) {
            System.out.println("exists(userId, roleId)===="+exists(userId, roleId));
